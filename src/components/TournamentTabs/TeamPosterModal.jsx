      ...
      <div className="flex flex-col items-center gap-3 w-full max-w-2xl">
        ...
        <div
          ...
          <div
            ...
            <div
              className={`absolute top-0 right-0 w-full h-[400px] bg-gradient-to-bl ${lightMode ? "from-teal-100/60 to-transparent" : "from-teal-900/30 to-transparent"} pointer-events-none`}></div>
            <div
              className={`absolute bottom-0 left-0 w-full h-[400px] bg-gradient-to-tr ${lightMode ? "from-indigo-100/60 to-transparent" : "from-indigo-900/20 to-transparent"} pointer-events-none`}></div>
            ...
            {/* Footer */}
            {/* <div
              className={`py-4 text-center text-[8px] font-black uppercase tracking-[0.3em] ${lightMode ? "text-gray-400" : "text-gray-600"}`}>
              Generated by CricSync • www.cricsync.com
            </div> */}
          </div>
        </div>

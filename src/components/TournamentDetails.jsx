...
import {
  ...
  writeBatch,
  deleteDoc,
  updateDoc, // IMPORTED: Needed to enable auction
  ...
  const fetchData = async () => {
    try {
      ...
      const loadedTeams = teamSnap.docs.map((d) => ({
        ...
        logo: d.data().logo,
        players: d.data().players || [], // Ensure players array exists
        roster: d.data().roster || [], // Ensure roster exists
      }));

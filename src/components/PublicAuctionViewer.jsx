...
export default function PublicAuctionViewer() {
  ...
  return (
    ...
    >
      ...
      <div className=" mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* LEFT/TOP: CURRENT PLAYER ON THE BLOCK */}
        <div className="lg:col-span-2">
          <div
            className={`rounded-[2rem] border overflow-hidden shadow-2xl relative ${lightMode ? "bg-white border-gray-200" : "bg-[#1C2128] border-white/5"}`}
          >
            <div
            ...
            {currentPlayer ? (
              <div className="p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
                ...
                <PlayerAvatar
                  ...
                  tournamentId={id}
                  className="w-64 h-64 rounded-3xl object-cover shadow-2xl border-4 border-white/10 shrink-0"
                />
        ...
        <div
          className={`rounded-[2rem] border p-6 shadow-xl flex flex-col max-h-[600px] ${lightMode ? "bg-white border-gray-200" : "bg-[#1C2128] border-white/5"}`}
        >
          <h3

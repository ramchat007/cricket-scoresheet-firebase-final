...
export default function LiveScoring() {
  ...
  const handleEmergencyScrub = async () => {
    ...
    try {
      ...
      // Because this new document is tiny, Firebase will accept it and overwrite the bloated one!
  ...
  return (
    ...
    >
      ...
      {/* {canScore && (
        <button 
          onClick={handleEmergencyScrub}
          className="fixed bottom-20 right-4 z-[100] bg-red-600 text-white font-black px-4 py-3 rounded-full shadow-2xl animate-bounce">
          🧹 SCRUB IMAGES
        </button>
      )} */}
